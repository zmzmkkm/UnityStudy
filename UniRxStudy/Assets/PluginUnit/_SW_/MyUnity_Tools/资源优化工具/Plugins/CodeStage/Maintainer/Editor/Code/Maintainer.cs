...
namespace CodeStage.Maintainer
{
	public class Maintainer : ScriptableObject
	{
		...
		[MenuItem("SW/资源优化工具/Maintainer/Show %#&`", false, 900)]
		private static void ShowWindow()
		{
			MaintainerWindow.Create();
		}

		[MenuItem("SW/资源优化工具/Maintainer/About", false, 901)]
		private static void ShowAbout()
		{
			MaintainerWindow.ShowAbout();
		}

		[MenuItem("SW/资源优化工具/Maintainer/Find Issues %#&f", false, 1000)]
		private static void FindAllIssues()
		{
			IssuesFinder.StartSearch(true);
		}

		[MenuItem("SW/资源优化工具/Maintainer/Find Garbage %#&g", false, 1001)]
